...
def main():
    ...
    EXCLUDE_TERMS = '(exoplanet OR main sequence OR pulsar OR neutron star OR Earth OR supernovae OR tidal disruption event OR pre–stellar OR asteroid OR Voigt OR FRB OR Fast radio burst OR galaxy evolution)' 
